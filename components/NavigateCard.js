...
const NavigateCard = () => {
    ...
    const toggleStyle = () => {
      setSelectedStyle(selectedStyle === 'bg-white' ? 'bg-pink-500 text-white' : 'bg-white');
    };

  return (
    <SafeAreaView
    style={tw`flex-1 ${selectedStyle}`}>
      <Text 
      style={tw `text-center py-5 text-xl ${selectedStyle}`}>Good Morning, Jacob!</Text>
